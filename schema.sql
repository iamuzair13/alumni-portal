...
CREATE TABLE public.tbl_alumni (
  ...
  higher_education_intiture_number text,
  higher_education_institute_email text,
  higher_education_institute_country text,
  higher_education_institute_province text,
  higher_education_institute_city text,
  about text,
  ...
  CONSTRAINT tbl_alumni_faculty_fkey FOREIGN KEY (faculty) REFERENCES public.tbl_faculties(id),
  CONSTRAINT tbl_alumni_department_fkey FOREIGN KEY (department) REFERENCES public.tbl_departments(id),
  CONSTRAINT tbl_alumni_program_fkey FOREIGN KEY (program) REFERENCES public.tbl_programs(id)
);
...
CREATE TABLE public.tbl_departments (
  ...
  CONSTRAINT tbl_departments_faculty_id_fkey FOREIGN KEY (faculty_id) REFERENCES public.tbl_faculties(id)
);
...
CREATE TABLE public.tbl_programs (
  ...
  CONSTRAINT tbl_programs_department_id_fkey FOREIGN KEY (department_id) REFERENCES public.tbl_departments(id)
);
