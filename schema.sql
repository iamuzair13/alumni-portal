...
create table public.tblalumnitalks (
  id serial not null,
  alumniid integer not null,
  alumnitalks character varying(10) null,
  mentorshipprogram character varying(10) null,
  topic text null,
  date_1 date null,
  timings_1 text null,
  activity text null,
  ...
  constraint tblalumnitalks_alumniid_fkey foreign KEY (alumniid) references tbl_alumni (alumniid) on delete CASCADE
) TABLESPACE pg_default;
