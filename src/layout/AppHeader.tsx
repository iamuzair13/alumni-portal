...
const AppHeader: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-40 flex border-b border-gray-200/70 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/70 dark:border-gray-800/70 dark:bg-gray-950/70 lg:border-b">
