      ...
      return NextResponse.json(
        {
          item: {
            ...
            strategyAssessmentMarks: Number.isFinite(Number(r.strategy_assessment_marks)) ? Number(r.strategy_assessment_marks) : 0,
            achievementAssessmentMarks: Number.isFinite(Number(r.achievement_assessment_marks)) ? Number(r.achievement_assessment_marks) : 0,
            bonusMarks: Number.isFinite(Number(r.bonus_marks)) ? Number(r.bonus_marks) : 0,
            roleDescription,
