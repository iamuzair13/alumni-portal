...
export async function POST(req: NextRequest) {
  try {
    ...
    const rows = await sql/* sql */`
      INSERT INTO public.leadership_role_criteria (role_id, label, description, is_mandatory, sort_order, created_at, updated_at)
      VALUES (${roleId}, ${label}, ${description}, ${isMandatory}, ${sortOrder}, NOW(), NOW())
      RETURNING id, label, description, is_mandatory, sort_order
    `;
