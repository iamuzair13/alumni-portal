   ...
   try {
     ...
     const extraBodyHtml = `
       <div style="margin: 16px 0; padding: 14px; border: 1px solid #e5e7eb; border-radius: 10px; background: #f9fafb;">
         <p style="margin: 0; font-size: 14px;"><strong>SAP ID / Registration No:</strong> ${String(alumni.sapid || alumni.registrationno || "-")}</p>
         <p style="margin: 6px 0 0 0; font-size: 14px;"><strong>Temporary Password:</strong> ${passwordToSend}</p>
       </div>
     `;
