...
export default function GymMembershipForm({ alumniId, sapId }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="max-w-2xl mx-auto dark:text-gray-100 dark:border-gray-700 dark:bg-gray-900 dark:outline-gray-700">
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-slate-900 mb-2 dark:text-gray-100 dark:border-gray-700 dark:bg-gray-900 dark:outline-gray-700">Gym Membership Application</h2>
