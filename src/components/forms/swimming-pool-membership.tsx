...
export default function SwimmingPoolMembershipForm({ alumniId, sapId }: Props) {
  ...
  const onSubmit = async (vals: FormVals) => {
    try {
      const loadingToast = toast.loading("Submitting your swimming pool membership application...");
      ...
      const res = await fetch("/api/alumni/swimming-pool-membership", {
        method: "POST",
      ...
      toast.success("Swimming pool membership application submitted successfully!");
