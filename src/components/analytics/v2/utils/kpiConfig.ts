  ...
  return [
    {
      ...
      items: [
        ...
        { title: "Active Alumni", value: formatKpiValue(kpis?.activeAlumni), subtitle: "Status active", icon: DashboardIcons.users, color: "emerald", sparkline: activeSpark, trend: activeSpark ? computeTrendDelta(activeSpark) : undefined },
        ...
        { title: "Engagement Rate", value: pct(kpis?.activeAlumni, ah?.total), subtitle: "Active / total", icon: DashboardIcons.users, color: "indigo" },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Associations", value: formatKpiValue(chapters?.associations), subtitle: "Alumni associations", icon: DashboardIcons.users, color: "amber" },
