    ...
    <div className="space-y-5">
      ...
      <section>
        <h3 className="mb-2 text-[11px] font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400">
          Verified transition timing by faculty
        </h3>
        <AnalyticsDataTable
          isLoading={isLoading}
          columns={[
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <section className="flex flex-col items-center rounded-xl border border-gray-200/80 bg-gray-50/50 p-4 dark:border-gray-800 dark:bg-gray-900/40">
          <h3 className="mb-3 w-full text-[11px] font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400">
            Early transition score
          </h3>
          <Gauge score={velocity.score} size={120} />
        </section>
        ...
        <section className="rounded-xl border border-gray-200/80 bg-gray-50/50 p-4 dark:border-gray-800 dark:bg-gray-900/40">
          ...
          <div className="h-[160px]">
            <Donut data={timingChartSeries} showLegend minSlicePercent={0.04} />
          </div>
        </section>
        ...
        <section className="rounded-xl border border-gray-200/80 bg-gray-50/50 p-4 dark:border-gray-800 dark:bg-gray-900/40">
          ...
          <BarMini data={timingChartSeries} height={160} horizontal showLabels />
        </section>
      </div>
