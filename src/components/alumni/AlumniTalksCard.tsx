    ...
    <div className="rounded-xl border border-gray-200 bg-white p-4 sm:p-5 md:p-6 shadow-sm">
      <div className="flex items-center justify-between gap-3">
        <div className="min-w-0">
          <h4 className="text-lg font-bold text-slate-900">Alumni Talks</h4>
          <p className="text-xs text-slate-600">View your talk applications and apply for a new talk.</p>
        </div>
        <Link
          href={href}
